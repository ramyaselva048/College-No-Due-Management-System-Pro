...
export const LandingPage: React.FC = () => {
  ...
  const { theme, isDark, setTheme, resetTheme } = useTheme();
        ...
        <section className="pt-12 sm:pt-16 pb-12 px-6 sm:px-12 max-w-5xl mx-auto text-center">
          ...
          <div className="mb-6 flex flex-wrap items-center justify-center gap-3">
            ...
            <div className="inline-flex items-center p-0.5 rounded-full bg-slate-200/80 dark:bg-slate-800/80 border border-slate-300/70 dark:border-slate-700 shadow-2xs">
              ...
              <button
                type="button"
                id="theme-select-reset"
                onClick={resetTheme}
                className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-[11px] font-medium text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-200 transition-all cursor-pointer"
